...
public class PlaceholderUtil extends PlaceholderExpansion {
    ...
    public String onRequest(OfflinePlayer player, String identifier) {
        ...
        if (identifier.equals("tier")) {
            TierPlayer tierPlayer = PlayerWrapper.getTierPlayer(player.getPlayer());
            return tierPlayer.getTier().getTierIcon();
        }

        if (identifier.equals("tiername")) {
            TierPlayer tierPlayer = PlayerWrapper.getTierPlayer(player.getPlayer());
            return tierPlayer.getTier().getTierName();
        }
